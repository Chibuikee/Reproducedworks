          ...
          >
            ...
            <ul
              className={`navigation ${
               ...
               nM:absolute top-[60px] right-0  nM:p-[80px_60px] nM:min-h-full nM:bg-background1 nM:gap-2 nM:flex-col nM:items-start nM:opacity-[0.95]
              ...
              {navData.map((item) => (
                ...
                >
                  <a
                    ...
                    title={item.name}
                    before=""
                    className="text-[white] border-solid border-b-[2px] border-b-[transparent]
                     ...
                     inline-block transition-[all] bg-[-100%] bg-[length:200%_100%]
                      ease-in-out duration-[0.2s] bg-gradient-to-r from-primaryhover
                       ...
                       text-transparent hover:bg-[0] before:content-[attr(before)]
